...
import xyz.qalcyo.rysm.core.utils.UnknownVersionException
...
object RysmCore {
    ...
    fun onInitialization(version: MinecraftVersions) {
        if (version != MinecraftVersions.SEVENTEEN && version != MinecraftVersions.EIGHT) throw UnknownVersionException("This version is not supported by Rysm!")
