...
class ActionBarGui : WindowScreen(version = ElementaVersion.V1, restoreCurrentGuiOnClose = true, enableRepeatKeys = true, drawDefaultBackground = false) {
    ...
    override fun initScreen(width: Int, height: Int) {
        window.onMouseDrag { mouseX, mouseY, mouseButton ->
            ...
            when (keyCode) {
                InputUtil.GLFW_KEY_UP -> RysmConfig.actionBarY -= 5
                InputUtil.GLFW_KEY_DOWN -> RysmConfig.actionBarY += 5
                InputUtil.GLFW_KEY_LEFT -> RysmConfig.actionBarX -= 5
                InputUtil.GLFW_KEY_RIGHT -> RysmConfig.actionBarX += 5
            }
        }
