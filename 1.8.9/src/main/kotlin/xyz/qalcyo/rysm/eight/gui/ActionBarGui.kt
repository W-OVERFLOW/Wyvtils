...
import xyz.qalcyo.rysm.core.config.RysmConfig.actionBarBackground
import xyz.qalcyo.rysm.core.config.RysmConfig.actionBarBackgroundColor
import xyz.qalcyo.rysm.core.config.RysmConfig.actionBarPadding
import xyz.qalcyo.rysm.core.config.RysmConfig.actionBarRound
import xyz.qalcyo.rysm.core.config.RysmConfig.actionBarRoundRadius
...
class ActionBarGui : WindowScreen(restoreCurrentGuiOnClose = true, enableRepeatKeys = true, drawDefaultBackground = false) {
    ...
    override fun onDrawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        val ingameGui = Rysm.mc.ingameGUI as GuiIngameAccessor
